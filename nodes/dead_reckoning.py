...
class DeadReckoning(object):
    def __init__(self):
        ...
        self.steering_efficiency= rospy.get_param('~steering_efficiency',0.5)
        ...
        # Set up services
        rospy.Service('start_steering_efficiency_calib', Empty, self.HandleStartCalibSteering)
        rospy.Service('stop_steering_efficiency_calib', Empty, self.HandleStopCalibSteering)
    ...
    def HandleStopCalibSteering(self, req):
        ...
        if not self.calibStarted:
          ...
          if not self.fullTurn == 0.0:
            self.steering_efficiency = abs(2.0*pi/self.fullTurn)
